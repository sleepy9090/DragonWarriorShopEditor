...
namespace DragonWarriorShopEditor
{
    public partial class FormKol : Form
    {
        ...
        private void buttonUpdateItems_Click(object sender, EventArgs e)
        {
            ...
            backend.setShopItem(0x19A1, comboBox1.SelectedValue.ToString());
            backend.setShopItem(0x19A2, comboBox2.SelectedValue.ToString());
            backend.setShopItem(0x19A3, comboBox3.SelectedValue.ToString());
            backend.setShopItem(0x19A4, comboBox4.SelectedValue.ToString());
            backend.setShopItem(0x19A5, comboBox5.SelectedValue.ToString());
            backend.setShopItem(0x19CC, comboBox6.SelectedValue.ToString());
            backend.setShopItem(0x19CD, comboBox7.SelectedValue.ToString());
            backend.setShopItem(0x19CE, comboBox8.SelectedValue.ToString());
            backend.setShopItem(0x19CF, comboBox9.SelectedValue.ToString());
